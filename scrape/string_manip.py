...
def getOtherIngredients(ingredientString: str, mainIngredient = None) -> typing.List[str]:
    ...
    remove_unneccessary_text = re.sub("[.;,-][^.;,-]*:", "", ingredientString)
    ...
    ingredient_list = re.split("[,.;-](?![^()]*\))\s*", remove_unneccessary_text)
